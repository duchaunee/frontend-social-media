    ...
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112 112">
      <defs>
        <clipPath id="clip-path">
          <path
            fill="none"
            d="M88.53 98.17l-9.01-27.9 13.12-4.24 10.38 32.14H88.53z"
          />
        </clipPath>
        ...
        <clipPath id="clip-path-3">
          <path
            fill="none"
            d="M67.5 43.87L32.16 60.84 17.99 38.21 48.7 13.84l18.8 30.03z"
          />
        </clipPath>
      </defs>
      <g id="No_Results" data-name="No Results">
        <path
          fill="#90c3ff"
          d="M74 12.26h6.69a1.55 1.55 0 011.55 1.55v9.71h-9.8V13.8A1.55 1.55 0 0174 12.26z"
        />
        <path
          strokeWidth="3.45"
          strokeMiterlimit="10"
        ...
        <path
          fill="#7a7d81"
          d="M83.35 98.17H92l-4.86-4.27-3.79 4.27zm0 0h18.66v1.41H83.35zm7.7-58.39l-13.3 32.06H98.1l7.21-30.15-14.26-1.91z"
        />
        <path
          fill="#7a7d81"
        ...
        <path
          ...
          strokeLinecap="round"
          fill="none"
          d="M82.23 36.33l-4.16 9.8-11.9-6.06"
        />
        <path
          strokeWidth="13.78"
          stroke="#1877f2"
        ...
        <path
          fill="#fff"
          d="M92.41 32.72l-4.5 10.96-10.82-6.54 4.01-9.23 11.31 4.81z"
        />
        <path
          fill="#bcc0c4"
          d="M108.9 37.81l-19.36 7 2.63 30.75h17.15V39.87a5.3 5.3 0 00-.42-2.06z"
        />
        <path
          fill="#fff"
          d="M106.64 35.29l-10.92-6.13-7.21-3.89a5.08 5.08 0 00-7.11 2.06L80.54 29a9.16 9.16 0 003.06 11.79l5.94 4L109 38a5.17 5.17 0 00-2.36-2.71zm-15.11 65.72h8.65l-4.87-4.27-3.78 4.27zm0 0h18.66v1.41H91.53z"
        />
